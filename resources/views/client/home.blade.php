                ...
                <div class="swiper-slide blog-main">
                    <div class="blog-box ratio3_2">
                        <a class="blog-img" href="{{ route('client.blog.show', $blog->slug) }}">
                            <img class="bg-img" src="{{ asset('storage/' . $blog->thumbnail) }}" alt="{{ $blog->title }}">
                        </a>
                    </div>
                    <div class="blog-txt">
                        <p>
                        ...
                        <div class="link-hover-anim underline">
                            <a class="btn btn_underline link-strong link-strong-unhovered" href="{{ route('client.blog.show', $blog->slug) }}">
                                Read More
                                <svg>
                                    <use href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#arrow"></use>
                                </svg>
                            </a>
                            <a class="btn btn_underline link-strong link-strong-hovered" href="{{ route('client.blog.show', $blog->slug) }}">
                                Read More
                                <svg>
                                    <use href="https://themes.pixelstrap.net/katie/assets/svg/icon-sprite.svg#arrow"></use>
                                </svg>
