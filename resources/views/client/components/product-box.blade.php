...
<div class="col-xxl-3 col-md-4 col-6">
    <div class="product-box">
        <div class="img-wrapper">
                ...
                <div class="label-block">
                    @foreach ($product->labels as $product_label)
                        <div class="label-item-wrapper" style="display:inline-block;max-width:60px;margin-right:10px">
                            <img style="width:100%" class="{{ $product_label->position }}"
                                src="{{ asset($product_label->image) }}" alt="label">
                        </div>
                    @endforeach
                </div>
            @endif
            ...
            <a href="{{ route('client.products.show', $product->slug) }}" style="display: block;">
