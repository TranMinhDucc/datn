                    ...
                    <div class="cart-listing">
                        ...
                        <div class="summary-total">
                            <ul>
                                ...
                                <li>
                                    <p>Phí vận chuyển</p><span>Enter shipping address</span>
                                </li>
                                <li>
                                    <p>Thuế</p>
                        ...
                        <div class="order-button"><button type="button" class="btn btn_black sm w-100 rounded">Place Order</button></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const total = Math.max(0, originalSubtotal - productDiscount - shippingDiscount + taxAmount);
...
if (window.location.href.includes('/checkout')) {
    ...
    document.querySelector('.order-button button').addEventListener('click', function(e) {
        ...
        const selectedPaymentMethodId = document.querySelector('input[name="payment_method_id"]:checked')?.value;
