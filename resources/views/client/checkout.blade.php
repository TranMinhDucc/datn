...
@section('contend')
    ...
    <section class="inner-section single-banner" style="background: url(images/single-banner.jpg) no-repeat center;">
        <div class="container">
            <h2>checkout</h2>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href='/assets/ltr/'>Home</a></li>
                <li class="breadcrumb-item"><a href='/assets/ltr/shop-4column'>shop grid</a></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="alert-info">
                        <p>Returning customer? <a href='/assets/ltr/login'>Click here to login</a></p>
                    </div>
                </div>
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="account-card mb-0">
                        ...
                        <div class="checkout-check">
                            ...
                            <label for="checkout-check">By making this purchase you agree to our <a href="#">Terms
                                    and Conditions</a>.</label>
                        </div>
                        <div class="checkout-proced">
                            <a class='btn btn-inline' href='/assets/ltr/invoice'>proced to checkout</a>
                        </div>
                    </div>
                </div>
            </div>
