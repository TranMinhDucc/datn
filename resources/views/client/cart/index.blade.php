                            ...
                            <table class="table" id="cart-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="cart-box"> <a href="product.html"> <img
                                                        src="{{ asset('assets/client/images/cart/category/1.jpg') }}"
                                                        alt=""></a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="cart-box"> <a href="product.html"> <img
                                                        src="{{ asset('assets/client/images/cart/category/2.jpg') }}"
                                                        alt=""></a>
                                                <div> <a href="product.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="cart-box"> <a href="product.html"> <img
                                                        src="{{ asset('assets/client/images/cart/category/3.jpg') }}"
                                                        alt=""></a>
                                                <div> <a href="product.html">
                    ...
                    <div class="cart-items">
                        ...
                        <div class="coupon-box">
                            ...
                            <ul>
                                ...
                                <li> <span> <a class="theme-color" href="login.html">Login </a>to see best coupon for you
                                    </span></li>
                            </ul>
                        </div><a class="btn btn_black w-100 rounded sm" href="{{ route('client.checkout.index') }}">Check
                            Out</a>
                    </div>
                </div>
                <div class="col-12">
