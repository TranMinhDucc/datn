                            ...
                            <div class="blog-main-box blog-details">
                                <div>
                                    <div class="blog-img"> <img class="img-fluid bg-img"
                                            src="{{ asset('assets/client/images/other-img/blog-details.jpg') }}"
                                            alt=""></div>
                                </div>
                                <div class="blog-content"><span class="blog-date">May 9, 2018 Stylish </span><a
                                    ...
                                    <p>Sed non mauris vitae erat consequat. Proin gravida nibh vel velit auctor aliquet.
                                        Aenean sollicitudin, lom quis bibenm auctor, nisi elit consequat ipsum, nec sagittis
                                        sem nibh id elit. Duis sed odio sit amet nibh vuutate cursus a sit amet maorbi We
                                        were making our way to the Rila Mountains, where we were visiting the Rila Monastery
                                        where we enjoyed scrambled eggs, toast, mekitsi, local jam and peppermint tea.</p>
                                    <span>We wandered the site with busloads of other tourists, yet strangely the place did
                                        not seem crowded. I’m not sure if it was the sheer size of the place, or whether the
                                        masses congregated in one area and didn’t venture far from the main church, but I
                                        didn’t feel overwhelmed by tourists in the monastery.</span><span
                                        class="mb-0">Even though winter is coming to an end, it's never too late to jump
                                        on the winter wear fashion bandwagon. Winter is many people’s favorite season,
                                        especially fashionistas, who see it as an opportunity to dress up to the nines.
                                        Winter lets us layer our clothes, giving us endless styling options with varied
                                        colors, styles, textures, fabrics, prints, and more.</span>
                                    <div class="quote-title">
                                        <h6><i class="fa-solid fa-quote-left"></i><span>Fashion you can buy, but style you
                                                possess. The key to style is learning who you are, which takes years.
                                                There's no how-to road map to style. It's about self expression and, above
                                                all, attitude. </span></h6>
                                    </div><span class="mt-0">I had low expectations about Sofia as a city, but after the
                                        walking tour I absolutely loved the place. This was an easy city to navigate, and it
                                        was a beautiful city – despite its ugly, staunch and stolid communist-built
                                        surrounds. Sofia has a very average facade as you enter the city, but once you lose
                                        yourself in the old town area, everything changes.Feeling refreshed after an
                                        espresso, we walked a short distance to the small but welcoming Banya Bashi Mosque,
                                        then descended into the ancient Serdica complex.</span>
