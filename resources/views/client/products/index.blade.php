                            ...
                            <div class="swiper product-slider product-slider-img">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"> <img
                                            src="{{ asset('assets/client/images/product/slider/1.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="{{ asset('assets/client/images/product/slider/2.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                    ...
                                    <div class="swiper-slide"> <img
                                            src="{{ asset('assets/client/images/product/slider/6.jpg') }}" alt="">
                                    </div>
                                    <div class="swiper-slide"> <img
                                            src="{{ asset('assets/client/images/product/slider/7.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
