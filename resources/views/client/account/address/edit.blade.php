                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="title" class="form-select">
                            <option value="Nhà riêng" {{ $address->title == 'Nhà riêng' ? 'selected' : '' }}>Nhà Riêng</option>
                            <option value="Công ty" {{ $address->title == 'Công ty' ? 'selected' : '' }}>Công Ty</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="phone" class="form-control" value="{{ $address->phone }}" placeholder="Nhập số điện thoại">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="country" class="form-control" value="{{ $address->country }}" placeholder="Nhập quốc gia">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label" style="color: #333;">Tỉnh / Thành Phố</label>
                        <input type="text" name="state" class="form-control" value="{{ $address->state }}" placeholder="Nhập tỉnh hoặc thành phố">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label" style="color: #333;">Quận / Huyện</label>
                        <input type="text" name="city" class="form-control" value="{{ $address->city }}" placeholder="Nhập quận hoặc huyện">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label" style="color: #333;">Mã Bưu Chính</label>
                        <input type="text" name="pincode" class="form-control" value="{{ $address->pincode }}" placeholder="Nhập mã bưu chính">
                    </div>
                </div>
