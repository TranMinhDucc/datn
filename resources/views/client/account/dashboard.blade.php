                                                ...
                                                <div class="img-wrapper">
                                                    ...
                                                    <div class="cart-info-icon"> <a href="#" data-bs-toggle="modal"
                                                            ...
                                                            tabindex="0"><i class="iconsax" data-icon="basket-2"
                                                                aria-hidden="true">
                                                            </i></a><a href="compare.html" title="Compare"
                            ...
                            <div class="dashboard-right-box">
                                <div class="address-tab">
                                    ...
                                    <div class="row gy-3">
                                                            ...
                                                            <input class="custom-radio" id="address-billing-0"
                                                                ...
                                                                class="address"> <span class="address-title">New Home
                                                                    ...
                                                                    class="address-home"> <span class="address-tag">
                                                                        Address:</span>26, Starts Hollow
                                                                    Colony, Denver, Colorado, United
                                        ...
                                        <div class="col-xxl-4 col-md-6">
                                            <div class="address-option">
                                                <label for="address-billing-3"> <span class="delivery-address-box">
                                                        <span class="form-check">
                                                            ...
                                                            class="address-detail"><span class="address"> <span
                                                                    ...
                                                                    California,
                                                                    United States</span></span><span class="address">
                                        ...
                                        <div class="col-xxl-4 col-md-6">
                                            <div class="address-option">
                                                <label for="address-billing-2"> <span class="delivery-address-box">
                                                        <span class="form-check">
