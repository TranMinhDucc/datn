    ...
    <div class="row">
      ...
      <div class="dashboard-left-sidebar sticky">
        ...
        <div class="profile-contain">
          <div class="profile-image"> <img class="img-fluid" src="{{ asset('assets/client/images/user/12.jpg') }}"
            alt=""></div>
          <div class="profile-name">
          <h4>{{$user['fullname']}}</h4>
          <h6>{{$user['email']}}</h6><span data-bs-toggle="modal" data-bs-target="#edit-box" title="Quick View"
