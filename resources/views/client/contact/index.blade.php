                            ...
                            <div class="contact-form">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input class="form-control" id="inputEmail5" type="email" name="email"
                                            placeholder="Enter Email Address">
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="inputEmail6">Phone Number</label>
                                        <input class="form-control" id="inputEmail6" type="number" name="number"
                                            placeholder="Enter Phone Number">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="inputEmail7">Subject</label>
                                        <input class="form-control" id="inputEmail7" type="text" name="text"
