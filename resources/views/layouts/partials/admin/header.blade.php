              ...
              <div class="app-navbar flex-shrink-0">
                      ...
                      <div id="kt_header_search" class="header-search d-flex align-items-stretch"
                          ...
                          <div class="d-flex align-items-center" data-kt-search-element="toggle"
                              ...
                              <div
                                  ...
                                  <i class="fa-solid fa-magnifying-glass fs-4"><span class="path1"></span><span
                                          class="path2"></span></i>
                              </div>
                          </div>
                          <!--end::Search toggle-->
                  ...
                  <div class="app-navbar-item ms-1 ms-md-4">
                      ...
                      <a href="#"
                          ...
                          <i class="fa-solid fa-circle-half-stroke fs-4"><span class="path1"></span><span
                      ...
                      <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                          ...
                          <div class="menu-item px-3 my-0">
                              <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                  ...
                                  <span class="menu-icon" data-kt-element="icon">
                                      <i class="fa-solid fa-sun fs-4"></i><span class="path1"></span><span
                          ...
                          <div class="menu-item px-3 my-0">
                              <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                  data-kt-value="dark">
                                  <span class="menu-icon" data-kt-element="icon">
                                      <i class="fa-solid fa-moon fs-4"><span class="path1"></span><span
                                              class="path2"></span></i>
                                  </span>
                                  <span class="menu-title">
                                      Dark
                          ...
                          <div class="menu-item px-3 my-0">
                              <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                  ...
                                  <span class="menu-icon" data-kt-element="icon">
                                      <i class="fa-solid fa-laptop-code fs-4"><span class="path1"></span><span
                                              class="path2"></span><span class="path3"></span><span
                                              class="path4"></span></i>
                                  </span>
                                  <span class="menu-title">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                                  ...
                                  <div class="menu-item px-3 my-0">
                                      <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                          data-kt-value="dark">
                                          <span class="menu-icon" data-kt-element="icon">
                                              <i class="fa-solid fa-moon fs-2"><span class="path1"></span><span
                                                      class="path2"></span></i>
                                          </span>
                                          <span class="menu-title">
                                              Dark
