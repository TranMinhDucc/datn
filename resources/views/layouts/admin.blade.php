...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
                                ...
                                <div class="row " data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            ...
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('assets/admin/assets/media/preview/demos/demo1/light-ltr.png') }}">                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('assets/admin/assets/media/preview/demos/demo1/dark-ltr.png') }}">                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="row gy-3" data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success active  active">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('assets/admin/assets/media/misc/layout/dark-sidebar.png') }}">                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('assets/admin/assets/media/misc/layout/light-sidebar.png') }}">                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('assets/admin/assets/media/misc/layout/dark-header.png') }}">                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="{{ asset('assets/admin/assets/media/misc/layout/light-header.png') }}">                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="overflow-auto pb-5">
                                    ...
                                    <div
                                        ...
                                        <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                            <!--begin::User-->
                                            <div class="symbol symbol-circle symbol-25px">
                                                <img src="{{ asset('assets/admin/assets/media/avatars/300-20.jpg') }}">                                            </div>
                                            <!--end::User-->
                                ...
                                <div class="overflow-auto pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('assets/admin/assets/media/avatars/300-1.jpg') }}">                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                </div>
                                ...
                                <div class="mb-5 pe-3">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('assets/admin/assets/media/avatars/300-23.jpg') }}">                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                </div>
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img src="{{ asset('assets/admin/assets/media/svg/files/pdf.svg') }}">                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <!--begin::Icon-->
                                            <img src="{{ asset('assets/admin/assets/media/svg/files/doc.svg') }}">                                            <!--end::Icon-->
                                        ...
                                        <div class="d-flex flex-aligns-center">
                                            <!--begin::Icon-->
                                            <img src="{{ asset('assets/admin/assets/media/svg/files/css.svg') }}">                                            <!--end::Icon-->
                                    ...
                                    <div
                                        ...
                                        <div class="overlay me-10">
                                            ...
                                            <div class="overlay-wrapper">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-29.jpg') }}">                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay me-10">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-31.jpg') }}">                                            </div>
                                            <!--end::Image-->
                                        ...
                                        <div class="overlay">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper">
                                                <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-40.jpg') }}">                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="pe-3 mb-5">
                                    ...
                                    <div class="d-flex align-items-center mt-1 fs-6">
                                        ...
                                        <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip"
                                            ...
                                            <img src="{{ asset('assets/admin/assets/media/avatars/300-4.jpg') }}">                                        </div>
                                        <!--end::User-->
                                    </div>
                                    <!--end::Description-->
                                </div>
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-1.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-3.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-8.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-26.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-21.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-34.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
                ...
                <div class="d-flex flex-stack">
                    ...
                    <!--begin::Pic-->
                    <div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
                        <img src="{{ asset('assets/admin/assets/media/stock/600x400/img-27.jpg') }}">                    </div>
                    <!--end::Pic-->
                </div>
                <!--end::Item-->
    ...
    <div class="app-engage " id="kt_app_engage">
        ...
        <a href="#" id="kt_app_engage_toggle_on" class="app-engage-btn app-engage-btn-toggle-on text-hover-primary p-0"
            ...
            <i class="ki-duotone ki-question fs-2 text-primary"><span class="path1"></span><span
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="index.html" data-kt-href="true"
                                                    ...
                                                    <span
                                                        ...
                                                        <img src="{{ asset('assets/admin/assets/media/preview/demos/placeholder.jpg') }}">                                                    </span>
                                                    <!--end::Thumbnail-->
                                                </a>
                                                <!--end::Preview-->
                                            </div>
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                    <img src="{{ asset('assets/admin/assets/media/svg/card-logos/visa.svg') }}">                                                    <img src="{{ asset('assets/admin/assets/media/svg/card-logos/mastercard.svg') }}">                                                    <img src="{{ asset('assets/admin/assets/media/svg/card-logos/american-express.svg') }}">                                                </div>
                                                <!--end::Card logos-->
                                            </div>
                                            <!--end::Input wrapper-->
                                        </div>
                                ...
                                <div data-kt-stepper-element="content">
                                    <div class="w-100 text-center">
                                        ...
                                        <div class="text-center px-4 py-15">
                                            <img src="{{ asset('assets/admin/assets/media/illustrations/sketchy-1/9.png') }}">                                        </div>
                                        <!--end::Illustration-->
                                    </div>
                                </div>
                                <!--end::Step 5-->
                        ...
                        <div class="mh-375px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-5.jpg') }}">                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-25.jpg') }}">                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img src="{{ asset('assets/admin/assets/media/avatars/300-12.jpg') }}">                                    </div>
                                    <!--end::Avatar-->
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="13">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img src="{{ asset('assets/admin/assets/media/avatars/300-13.jpg') }}">                                            </div>
                                            <!--end::Avatar-->
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img src="{{ asset('assets/admin/assets/media/avatars/300-21.jpg') }}">                                            </div>
                                            <!--end::Avatar-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                    ...
                    <div class="btn btn-light-primary fw-bold w-100 mb-8">
                        <img src="{{ asset('assets/admin/assets/media/svg/brand-logos/google-icon.svg') }}">                        Invite Gmail Contacts
                    </div>
