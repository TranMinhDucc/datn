				...
				<div class="card-body py-4">
								...
								<th class="w-10px pe-2">
									<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
										<input class="form-check-input" type="checkbox" data-kt-check="true"
											data-kt-check-target="#kt_blogs_table .form-check-input" value="1" />
									</div>
								</th>
								...
								<tr>
									...
									<td>
										<div class="d-flex align-items-center">
											...
											<div class="d-flex flex-column">
												<span
													class="text-gray-800 fw-bold">{{ $blog->author->username ?? 'N/A' }}</span>
									...
									<td class="text-end">
										...
										<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
											...
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="#" class="menu-link px-3" data-kt-blog-table-filter="delete_row"
													data-url="{{ route('admin.blogs.destroy', $blog->slug) }}">
													Xóa
												</a>
											</div>
											<!--end::Menu item-->
					...
					<div class="d-flex justify-content-between align-items-center mt-4">
						<div class="text-muted fs-6">
							Hiển thị {{ $blogs->firstItem() ?? 0 }} đến {{ $blogs->lastItem() ?? 0 }} trong tổng số
							{{ $blogs->total() }} kết quả
						</div>
						<div>
							{{ $blogs->appends(request()->query())->onEachSide(1)->links('pagination::bootstrap-5') }}
						</div>
					</div>
