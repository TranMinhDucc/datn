                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_blogs_table">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">Ảnh đại diện</th>
                                <th class="min-w-150px">Danh mục</th>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                ...
                                                @else
                                                    <div
                                                        class="symbol-label fs-6 bg-light-info text-info d-flex align-items-center justify-content-center">
