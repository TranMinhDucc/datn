                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" multiple data-kt-select2="true"
                                            data-close-on-select="false" data-placeholder="Chọn trạng thái"
                                            data-dropdown-parent="#kt_menu_brands_filter" data-allow-clear="true">
                                            <option></option>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @forelse($brands as $brand)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="ms-5">
                                                    <a href="{{ route('admin.brands.edit', $brand) }}"
                                                        ...
                                                        data-kt-ecommerce-brand-filter="brand_name">
                                                        {{ $brand->name }}
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <span
                                                    class="badge {{ $brand->status ? 'badge-light-success' : 'badge-light-danger' }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">Không có thương hiệu nào.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
