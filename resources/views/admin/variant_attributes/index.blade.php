                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ route('admin.variant_attributes.edit', $attr->id) }}" class="dropdown-item">
                                                    <i class="fa-solid fa-pen-to-square me-2 text-primary"></i> Sửa
                                                </a>
                                            </li>
                                            <li>
                                                <form action="{{ route('admin.variant_attributes.destroy', $attr->id) }}" method="POST" onsubmit="return confirm('Xóa thuộc tính này?')">
                                                    @csrf
                                                    @method('DELETE')
