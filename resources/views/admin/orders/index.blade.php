        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
            <thead>
                <tr class="text-start text-gray-500 fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-end min-w-100px">Shipping</th>
                    <th class="text-end min-w-150px">Payment</th>
                    <th class="text-end min-w-130px">Cancel Request</th>
                    <th class="text-end min-w-130px">Date Added</th>
                    <th class="text-end min-w-130px">Date Modified</th>
                    ...
                    <tr>
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <div class="symbol-label bg-light">
                                        <img src="{{ asset('path/to/default-avatar.jpg') }}"
                                            alt="{{ $order->user->name ?? 'Unknown' }}" class="w-100" />
                                    </div>
                                </div>
                                <div class="ms-5">
                        ...
                        <td class="text-end">
                            @if($order->cancel_request)
                                <span class="badge badge-danger">Đã yêu cầu</span>
                                <br>
                                <small>{{ Str::limit($order->cancel_reason, 30) }}</small>
                            @else
