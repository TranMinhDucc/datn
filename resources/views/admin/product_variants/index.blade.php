                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" class="form-control form-control-solid w-250px ps-12" placeholder="Tìm kiếm biến thể" />
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @foreach($variant->attributes as $attr)
                                            <span class="badge bg-light-info text-dark">{{ $attr->name }}: {{ $attr->pivot->value }}</span><br>
                                        @endforeach
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><a href="{{ route('admin.product_variants.edit', $variant->id) }}" class="dropdown-item">Sửa</a></li>
                                                <li>
