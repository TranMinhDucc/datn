                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <!-- <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-category-search name="search"
                    ...
                    <div style="overflow-x: auto;">
                        ...
                        <div style="overflow-x: auto;">
                            <table class="table align-middle table-row-dashed fs-6 gy-5" style="min-width: 1300px;"
                                ...
                                $hasChildren =
                                $categories->where('parent_id', $category->id)->count() > 0;
                                $isParent = $level === 0;
                                ...
                                echo '<tr data-id="' .
                                    ...
                                    echo '<td title="' . e($breadcrumbText) . '">';
                                        if ($hasChildren) {
                                        echo '<span class="toggle-btn" onclick="toggleChildren(' .
                                                        $category->id .
                                                        ', this)">▸</span> ';
                                        } else {
                                    ...
                                    echo '<td>';
                                        if ($category->trashed()) {
                                        echo '<span class="badge bg-danger">Đã xóa</span>';
                                        } else {
                                    ...
                                    echo '<td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <form action="' . route('admin.categories.restore', $category->id) . '" method="POST" onsubmit="return confirm(\'Khôi phục danh mục này?\');">
                                                    ' . csrf_field() . '
                                                    <button type="submit" class="menu-link px-3">Khôi phục</button>
                                                </form>
                                            </div>';
                                            } else {
                                            echo '
                                    ...
                                    renderRows($categories, $category->id, $level + 1, $stt, $categoryMap, [
                                    ...$breadcrumb,
                                    $category->name,
                                    ]);
                                    }
