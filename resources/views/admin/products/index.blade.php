                            ...
                            <tbody class="fw-semibold text-gray-600 align-middle">
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        {{-- Mã sản phẩm --}}
                                        <td class="text-center">
                                            <a href="#" class="btn btn-gradient-warehouse btn-sm">
                                                <i class="fa-solid fa-cart-shopping fs-6"></i> Kho hàng
                                            </a>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.products.edit', ['product' => $product->id, 'page' => request('page', 1)]) }}"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3"
                                                        onclick="event.preventDefault(); if(confirm('Bạn chắc chắn muốn xóa?')) document.getElementById('delete-form-{{ $product->id }}').submit();">
                                                        Xóa
                                                    </a>
                                                </div>
                                            </div>
