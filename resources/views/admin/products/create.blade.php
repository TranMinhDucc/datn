            ...
            <form id="product-form" action="{{ route('admin.products.store') }}" method="POST"
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <div class="text-muted fs-7">Set the product is special offer.</div>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4 ">
                        ...
                        <div class="card-body pt-0 d-grid gap-4"> {{-- 👈 giãn dọc toàn phần --}}
                            <div>
                            ...
                            <div class="mt-6">
                                <label class="form-label mb-2">Ảnh phụ</label>
                                <input type="file" name="images[]" id="image-input" class="form-control mb-2" multiple accept=".png,.jpg,.jpeg">
                                <div id="image-preview-container" class="mt-2 d-flex flex-wrap gap-3"></div>
                            </div>

                            <div>
                                <label class="form-label mb-2">Ảnh bảng size</label>
                                <input type="file" name="size_chart" id="size-chart-input" class="form-control mb-2" accept=".png,.jpg,.jpeg">
                                <div id="size-chart-preview-container" class="mt-2 d-flex flex-wrap gap-3"></div>
                            </div>
...
<script>
    ...
    document.getElementById('size-chart-input').addEventListener('change', function(event) {
        const container = document.getElementById('size-chart-preview-container');
        container.innerHTML = ""; // clear preview cũ
