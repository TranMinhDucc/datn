    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="{{ route('admin.wishlists.create') }}" class="btn btn-danger">
                    Thêm yêu thích
                </a>
            </div>
        </div>
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush">
                <div class="card-body pt-0">
                                    ...
                                    <td class="text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a href="{{ route('admin.wishlists.edit', $item->id) }}" class="dropdown-item">
                                                        <i class="fa fa-edit me-2"></i> Sửa
                                                    </a>
                                                </li>
                                                <li>
                                                    <form action="{{ route('admin.wishlists.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Xoá mục này?')">
                                                        @csrf @method('DELETE')
                    ...
                    @if ($wishlists instanceof \Illuminate\Pagination\LengthAwarePaginator)
                        <div class="mt-4">
                            {{ $wishlists->links() }}
                        </div>
                    @endif
