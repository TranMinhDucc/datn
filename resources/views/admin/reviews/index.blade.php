...
<div class="d-flex flex-column flex-column-fluid">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" class="form-control form-control-solid w-250px ps-12" placeholder="Tìm đánh giá" />
                        </div>
                    </div>
                </div>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
            <li>
                <a href="{{ route('admin.reviews.edit', $review) }}" class="dropdown-item">Sửa</a>
            </li>
            <li>
                <a href="{{ route('admin.reviews.show', $review) }}" class="dropdown-item">Xem</a>
            </li>
            <li>
                <form action="{{ route('admin.reviews.destroy', $review) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Bạn chắc chắn muốn xóa?')" class="dropdown-item text-danger">
                        Xóa
                    </button>
                </form>
            </li>
