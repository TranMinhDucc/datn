                    ...
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid" multiple data-kt-select2="true"
                                ...
                                data-dropdown-parent="#kt_menu_683933b31c6f4" data-allow-clear="true">
                                <option></option>
                                ...
                                <div class="row " data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="../../../assets/media/preview/demos/demo1/dark-ltr.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                ...
                                <div class="row gy-3" data-kt-buttons="true"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success active  active">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="../../../assets/media/misc/layout/dark-sidebar.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="../../../assets/media/misc/layout/light-sidebar.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="../../../assets/media/misc/layout/dark-header.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="col-6">
                                        ...
                                        <label class="form-check-image form-check-success   ">
                                            <!--begin::Image-->
                                            <div class="form-check-wrapper border-gray-200 border-2">
                                                <img src="../../../assets/media/misc/layout/light-header.png"
                                                    class="form-check-rounded mw-100" alt="" />
                                            </div>
                                            <!--end::Image-->
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../projects/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Projects </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../ecommerce/catalog/products.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Ecommerce </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../customers/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Customers </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../subscriptions/list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Subscriptions </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="list.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        User Management </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../invoices/create.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Invoices </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../support-center/overview.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Support Center </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../calendar.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Calendar </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../file-manager/folders.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        File Manager </h3>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <!--begin::Preview-->
                                                <a href="../../inbox/listing.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3 class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                                        Inbox </h3>
                                            ...
                                            <div class="tab-pane fade " id="kt_app_engage_prebuilts_tab_pages_search"
                                                ...
                                                <div class="row g-10">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!--begin::Preview-->
                                                        <a href="../../../utilities/search/users.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
