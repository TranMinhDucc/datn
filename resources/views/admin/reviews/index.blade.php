...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_683933b31c6f4">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_683933b31c6f4" data-allow-clear="true">
                    <option></option>
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/apps/user-management/users/list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 May 2025 04:36:10 GMT -->
</html>
@endsection