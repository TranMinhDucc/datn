...
@section('content')
                        ...
                        <div class="card-body">
                            ...
                            <div id="button-container">
                                ...
                                @if (!empty($oldButtons))
                                    ...
                                    @endforeach
                                @else
                                    {{-- Nếu không có dữ liệu cũ thì render 1 nút trống --}}
                                    <div class="row mb-3">
                                        <div class="col-md-5">
                                            <input type="text" name="buttons[0][ten]" class="form-control"
                                                placeholder="Tên nút (VD: Mua ngay)">
                                            @error("buttons.0.ten")
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-5">
                                            <input type="text" name="buttons[0][duong_dan]" class="form-control"
                                                placeholder="Link nút (http://...)">
                                            @error("buttons.0.duong_dan")
                                                <div class="text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                            ...
                            <button type="button" class="btn btn-sm btn-light-primary" onclick="addButton()">➕ Thêm
                                nút</button>
                        </div>
    ...
    <script>
        let buttonIndex = {{ count(old('buttons', [0])) }};
    </script>
