    ...
    <div class="card-body p-9">
        ...
        <div class="d-flex flex-wrap mb-5">
            ...
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">            
                <div class="fs-6 text-gray-800 fw-bold">Jun 20, 2025</div>
...
<a href="project.html" class="card border-hover-primary ">
    ...
    <div class="card-body p-9">
        ...
        <div class="d-flex flex-wrap mb-5">
            <!--begin::Due-->
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">            
                <div class="fs-6 text-gray-800 fw-bold">Dec 20, 2025</div>
                <div class="fw-semibold text-gray-500">Due Date</div>
            </div>
            <!--end::Due-->
...
<a href="project.html" class="card border-hover-primary ">
    ...
    <div class="card-body p-9">
        ...
        <div class="d-flex flex-wrap mb-5">
            <!--begin::Due-->
            <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-7 mb-3">            
                <div class="fs-6 text-gray-800 fw-bold">Mar 10, 2025</div>
                <div class="fw-semibold text-gray-500">Due Date</div>
            </div>
            <!--end::Due-->
