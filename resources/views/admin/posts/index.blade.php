	...
	<div id="kt_app_content_container" class="app-container  container-xxl ">
		...
		<div class="row g-6 g-xl-9">
			...
			<div class="col-md-6 col-xl-4">
				<!--begin::Card-->
				<a href="{{ route('admin.posts.show', $post) }}" class="card border-hover-primary">
					<!--begin::Card header-->
					...
					<div class="card-body p-9">
						...
						<!--begin::Progress (chưa dùng, có thể là độ dài bài viết, hoặc trạng thái khác)-->
						{{-- <div class="h-4px w-100 bg-light mb-5">
                        <div class="bg-primary rounded h-4px" style="width: 50%"></div>
                    </div> --}}

						<!--begin::Users (chưa có author nên tạm ẩn)-->
						...
						<div class="timeline-content mb-10 mt-n1">
							...
							<div class="overflow-auto pb-5">
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
									<!--begin::Title-->
									<a href="project.html" class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
									<!--end::Title-->
								...
								<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
									<!--begin::Title-->
									<a href="project.html" class="fs-5 text-gray-900 text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
									<!--end::Title-->
