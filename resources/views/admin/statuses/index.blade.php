...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_683933b35a9a3">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" multiple data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_683933b35a9a3" data-allow-clear="true">
                    <option></option>
...
<!--end::User Info-->        <!--end::Summary-->
        ...
        <div id="kt_user_view_details" class="collapse show">
            <div class="pb-5 fs-6">
                    ...
                    <div class="text-gray-600">21 Feb 2025, 11:30 am</div>
                    <!--begin::Details item-->
                            </div>
        </div>
        <!--end::Details content-->
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                <tbody>
                            ...
                            <td>
                               POST /v1/invoice/in_8313_6575/invalid                            </td>
                            <td class="pe-0 text-end min-w-200px">
                                25 Oct 2025, 9:23 pm                            </td>
                        </tr>
                                                                    <tr>
                            <td class="min-w-70px">
                            ...
                            <td>
                               POST /v1/customer/c_683933b35ad1c/not_found                            </td>
                            <td class="pe-0 text-end min-w-200px">
                                20 Dec 2025, 11:30 am                            </td>
                        </tr>
                                                                    <tr>
                            <td class="min-w-70px">
                                <div class="badge badge-light-danger">500 ERR</div>
                            ...
                            <td>
                               POST /v1/invoice/in_6263_2421/invalid                            </td>
                            <td class="pe-0 text-end min-w-200px">
                            ...
                            <td>
                               POST /v1/customer/c_683933b35ad1e/not_found                            </td>
                            <td class="pe-0 text-end min-w-200px">
                                24 Jun 2025, 9:23 pm                            </td>
                        </tr>
                                                                    <tr>
                            <td class="min-w-70px">
                            ...
                            <td>
                               POST /v1/invoices/in_3472_5844/payment                            </td>
                            <td class="pe-0 text-end min-w-200px">
...
<div class="row">
			...
			<a class="fw-6 fw-semibold" href="list.html">
				User Management			</a>
...
<!-- Mirrored from preview.keenthemes.com/metronic8/demo1/apps/user-management/users/view.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 30 May 2025 04:36:14 GMT -->
</html>
@endsection