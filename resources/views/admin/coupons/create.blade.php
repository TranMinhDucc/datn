    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="discount_value" class="form-control @error('discount_value') is-invalid @enderror" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="max_usage" class="form-control @error('max_usage') is-invalid @enderror" required>
                @error('max_usage')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
