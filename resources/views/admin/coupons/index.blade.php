                                            ...
                                            <td>
                                                @switch($coupon->type)
                                                    @case('product_discount')
                                                        <span class="badge badge-light-primary">Giảm giá sản phẩm</span>
                                                    @break

                                                    @case('shipping_discount')
                                                        <span class="badge badge-light-info">Giảm phí vận chuyển</span>
                                                    @break

                                                    @case('order_discount')
                                                        <span class="badge badge-light-success">Giảm tổng đơn</span>
                                                    @break
                                                ...
                                                @if ($coupon->value_type === 'percentage')
                                                    ...
                                                    @if ($coupon->max_discount_amount)
                                                        <br><small class="text-muted">Tối đa
                                                            {{ number_format($coupon->max_discount_amount) }}đ</small>
                                                    @endif
                                                @else
                                                    <span
                                                        class="text-success fw-bold">{{ number_format($coupon->discount_value) }}đ</span>
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if ($coupon->start_date)
                                                    <span class="badge badge-light-success">
                                                        Bắt đầu: {{ $coupon->start_date->format('d/m/Y H:i') }}
                                                    </span>
                                                @else
                                                    <span class="badge badge-light-secondary">Không có</span>
                                                @endif
                                                <br>
                                                @if ($coupon->end_date)
                                                    <span class="badge badge-light-danger">
                                                        Kết thúc: {{ $coupon->end_date->format('d/m/Y H:i') }}
                                                    </span>
                                                @else
                                                    <span class="badge badge-light-secondary">Không có</span>
                                                @endif
