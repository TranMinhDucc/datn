    ...
    <div class="container mt-5">
        <div class="card p-4">
            ...
            <div class="card-body pt-0">
                    ...
                    <form method="POST" action="{{ route('admin.contacts.reply', $contact->id) }}">
                        ...
                        <div class="max-w-4xl mx-auto"> <!-- Tăng giới hạn container -->
                            <textarea name="replyContent" required
                                ...
                                placeholder="Nhập nội dung phản hồi tại đây..."> Cảm ơn bạn đã liên hệ. Chúng tôi sẽ phản hồi sớm nhất.</textarea>
                        </div>
                ...
                @else
                    <p><strong>Đã phản hồi vào:</strong>
                        {{ \Carbon\Carbon::parse($contact->replied_at)->format('d/m/Y H:i') }}</p>
                @endif
                {{-- Nút quay lại --}}
