...
@section('title', 'Thêm Chuyên mục Blog')
@section('content')
<!--begin::Content-->
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <!--begin::Form-->
        <form id="kt_blog_category_form" class="form d-flex flex-column flex-lg-row" action="{{ route('admin.blog-categories.store') }}" method="POST">
            @csrf
            <!--begin::Aside column-->
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="name" class="form-control mb-2 @error('name') is-invalid @enderror" placeholder="Nhập tên chuyên mục" value="{{ old('name') }}" />
                            <!--end::Input-->
                            @error('name')
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Nhập mô tả chuyên mục">{{ old('description') }}</textarea>
                            <!--end::Editor-->
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control mb-2" placeholder="duong-dan-url" readonly />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Đường dẫn URL sẽ được tạo tự động từ tên chuyên mục.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const slugPreview = document.querySelector('input[placeholder="duong-dan-url"]');
