...
themeBtnParent?.addEventListener("click", function (e) {
    ...
    if (clicked === "dark-btn") {
        ...
        localStorage.setItem(
            "textContentDark",
            `<i class="fa-solid fa-sun"></i> <div class="dark">Light</div>`
        );
    }
    if (clicked === "light-btn") {
        ...
        localStorage.setItem(
            "textContentDark",
            `<i class="fa-regular fa-moon"></i> <div class="dark">Dark</div>`
        );
    }
});
...
rtlBtn.id = localStorage.getItem("rtlBtnId")
    ...
    : "rtl-btn";
rtlBtn.querySelector(".rtl").textContent = localStorage.getItem(
    "textContentRtl"
)
...
darkBtn.id = localStorage.getItem("darkId")
    ...
    : "dark-btn";
darkBtn.innerHTML = localStorage.getItem("textContentDark")
    ? localStorage.getItem("textContentDark")
    : `<i class="fa-regular fa-moon"></i> <div class="dark">Dark</div>`;
